...
export const TemperatureAndDetails = ({weatherObject: { details, icon, temp, temp_min, temp_max, sunrise, sunset, speed, humidity, feels_like, timezone }}) => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row items-center justify-between text-white py-3">
        <img src={iconURLFromCode(icon)} alt="weather-icon" className="w-[118.812px]"/>
